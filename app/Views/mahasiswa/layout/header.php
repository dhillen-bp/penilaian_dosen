                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-center">
                        <div href="#" class="dropdown-item">
                            ...
                            <div class="card-body box-profile">
                                ...
                                <p class="text-info text-center">@<?= session()->get('username') ?> | <?= session()->get('nim') ?></p>
                            </div>
                            <!-- Profil End -->
                        </div>
                        <div class="dropdown-divider"></div>
                        <a href="<?= base_url(); ?>/login/logout" class="btn btn-danger btn-block"><b> Logout <i class="fas fa-sign-out-alt ml-1"></i></b></a>
                    </div>
                </li>
