                        ...
                        <form id="quickForm" action="" method="post">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="kd_matkul" class="form-control" id="kd_matkul" value="<?= $matkul['kd_matkul']; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="nm_matkul">Nama Mata Kuliah</label>
                                    <input type="text" name="nm_matkul" class="form-control" id="nm_matkul" value="<?= $matkul['nm_matkul']; ?>">
                                </div>
                                <div class="form-group">
                                    ...
                                    <select class="custom-select" name="id_dosen" id="id_dosen" required>
                                        ...
                                        foreach ($dosens as $dosen) : ?>
                                            <option value="<?= $matkul['id_dosen']; ?>" <?= ($dosen['nidn'] == $matkul['id_dosen']) ? 'selected' : '' ?>><?= $dosen['nm_dosen']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select class="custom-select" name="id_angkatan" id="id_angkatan">
                                        ...
                                        foreach ($angkatans as $angkatan) : ?>
                                            <option value="<?= $matkul['id_angkatan']; ?>" <?= ($angkatan['tahun_ajar'] == $matkul['id_angkatan']) ? 'selected' : '' ?>><?= $angkatan['tahun_ajar']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="id_semester">Semester</label>
                                    <input type="text" name="id_semester" class="form-control" id="id_semester" value="<?= $matkul['semester']; ?>" required>
                                </div>
