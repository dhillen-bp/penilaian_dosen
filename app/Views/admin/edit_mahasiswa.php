                        ...
                        <form id="quickForm" action="" method="post">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="tahun_masuk" class="form-control" id="tahun_masuk" value="<?= $mhs['tahun_masuk']; ?>">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="password" class="form-control" id="password" value="<?= $mhs['password']; ?>">
                                </div>
